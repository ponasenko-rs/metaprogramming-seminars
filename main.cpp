...
//    namespace tl = type_list;
    ...
    // Remove
    static_assert(tl::Same_v<tl::Remove_t<List, int>, tl::TypeList<float, bool>>);
    static_assert(tl::Same_v<tl::Remove_t<List, float>, tl::TypeList<int, bool>>);
    static_assert(tl::Same_v<tl::Remove_t<List, bool>, tl::TypeList<int, float>>);
    static_assert(tl::Same_v<tl::Remove_t<List, double>, tl::TypeList<int, float, bool>>);

    static_assert(tl::Same_v<tl::Remove_t<tl::EmptyTypeList, double>, tl::EmptyTypeList>);
    static_assert(tl::Same_v<
            tl::Remove_t<
                    tl::Remove_t<
                            tl::Remove_t<tl::TypeList<bool, bool, bool>, bool>,
                            bool>,
                    bool>,
            tl::EmptyTypeList
    >);
    static_assert(tl::Same_v<
            tl::Remove_t<tl::TypeList<bool, int, bool, double, bool>, bool>,
